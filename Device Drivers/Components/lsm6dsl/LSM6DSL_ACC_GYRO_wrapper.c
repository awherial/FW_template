/******************************************************************************
*   @file        LSM6DSL_ACC_GYRO_wrapper.c
...
===============================================================================
 02 Feb 2018 - 03.23am:
    By : ...
        Rev 1.0 : LSM6DSL_ACCGYRO_wrapper.c file template created.
 ------------------------------------------------------------------------------
...
***/
DrvContextTypeDef   lsm_6dsl_handle;
...
void lsm6dsl_write_cb (DMA_XFER_CB_E  cb_type)  {
    ...
    switch (cb_type)
    {
        case DMA_XFER_COMPLETE_CB  :
            // todo
            break;
        case DMA_XFER_HALF_CMPLT_CB:
            // todo
            break;
        case DMA_XFER_ERROR_CB     :
            // todo
            break;
        case DMA_XFER_ABORT_CB     :
        case DMA_XFER_ANY_CB       :
            // todo
            break;
    }
